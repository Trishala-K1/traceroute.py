            ...
            # Fill in end
                ...
                if types == 11:
                    ...
                    timeSent = struct.unpack("d", recvPacket[28:28 +
                                                                bytes])[0]
                    # Fill in start
                    df = df.append({'Hop Count': str(ttl), 'Try': str(tries), 'IP': str(addr[0]), 'Hostname': hname,
                                    'Response Code': str(types)}, ignore_index=True)
                    print (df)
                    ...
                    df = df.append({'Hop Count': str(ttl), 'Try': str(tries+1), 'IP': str(addr[0]), 'Hostname': hname,
